...
def read_csv(filename):
    ...
    second row.
    :param filename: the file name of the csv file located in the data folder
    :return: the tuples and attributes of the csv file
    """
    lines = []
    with open(f'data/{filename}', 'r') as csv_file:
...
def read_json(filename):
    ...
    :param filename: the name of the json file located in the data folder
    :return: the attribute types, ordinal attribute values and attributes to ignore
    """
    f = open(f'data/{filename}', 'r')  # open file
    ...
    return attribute_types, ordinal_attribute_values, attributes_to_ignore
...
def read_data(json_file_name, csv_file_name):
    ...
    attribute_types, ordinal_attribute_values, attributes_to_ignore = read_json(
        json_file_name)

    # read the data from the csv file
    all_tuples, attributes = read_csv(csv_file_name)

    return all_tuples, attributes, attribute_types, ordinal_attribute_values, attributes_to_ignore
